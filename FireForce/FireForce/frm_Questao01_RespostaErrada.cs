...
namespace FireForce
{
    public partial class frm_Questao01_RespostaErrada : Form
    {
        // ==== BOTÃO PROXIMO
        ...
        public frm_Questao01_RespostaErrada()
        {
            InitializeComponent();
        ...
        private void frm_Questao01_RespostaErrada_Load(object sender, EventArgs e)
        {
        ...
        {
            picbox_Errado.Image = Properties.Resources.Quiz_Questao01_ErradoCorrecao;
        ...
        {
            picbox_Errado.Image = Properties.Resources.Quiz_Questao01_Errado;
