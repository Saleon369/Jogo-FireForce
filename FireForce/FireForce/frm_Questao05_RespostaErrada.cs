...
namespace FireForce
{
    public partial class frm_Questao05_RespostaErrada : Form
    {
        // ==== BOTÃO PROXIMO
        ...
        public frm_Questao05_RespostaErrada()
        {
            InitializeComponent();
        ...
        private void frm_Questao05_RespostaErrada_Load(object sender, EventArgs e)
        {
        ...
        {
            picbox_Errado.Image = Properties.Resources.Quiz_Questao05_ErradoCorrecao;
        ...
        {
            picbox_Errado.Image = Properties.Resources.Quiz_Questao05_Errado;
