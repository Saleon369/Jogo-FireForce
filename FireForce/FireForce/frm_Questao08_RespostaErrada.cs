...
namespace FireForce
{
    public partial class frm_Questao08_RespostaErrada : Form
    {
        // ==== BOTÃO PROXIMO
        ...
        public frm_Questao08_RespostaErrada()
        {
            InitializeComponent();
        ...
        private void frm_Questao08_RespostaErrada_Load(object sender, EventArgs e)
        {
        ...
        { 
            ...
            {
                frm_TelaFinal TelaFinal = new frm_TelaFinal();
                this.Visible = false;
            ...
            {
                frm_Questao09 Questao09 = new frm_Questao09();
                this.Visible = false;
                Questao09.ShowDialog();
                this.Close();
            }
        }
        ...
        {
            picbox_Errado.Image = Properties.Resources.Quiz_Questao08_ErradoCorrecao;
        ...
        {
            picbox_Errado.Image = Properties.Resources.Quiz_Questao08_Errado;
